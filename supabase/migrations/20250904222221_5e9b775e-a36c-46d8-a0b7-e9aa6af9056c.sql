-- Create sample users for demonstration (simplified approach)
...
INSERT INTO public.routes (id, origin_id, destination_id, distance_km, estimated_time_hours, base_price, price_per_kg, is_active) VALUES
    ('aaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '55555555-5555-5555-5555-555555555555', '66666666-6666-6666-6666-666666666666', 95, 1.5, 150.00, 2.50, true),
    ('bbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '55555555-5555-5555-5555-555555555555', '77777777-7777-7777-7777-777777777777', 65, 1.2, 120.00, 3.00, true),
    ('ccccccc-cccc-cccc-cccc-cccccccccccc', '66666666-6666-6666-6666-666666666666', '88888888-8888-8888-8888-888888888888', 25, 0.5, 80.00, 4.00, true),
    ('ddddddd-dddd-dddd-dddd-dddddddddddd', '77777777-7777-7777-7777-777777777777', '99999999-9999-9999-9999-999999999999', 5, 0.2, 50.00, 5.00, true)
ON CONFLICT (id) DO NOTHING;